        ...
        >
          {[
            ...
            <a
              ...
              href={href}
              aria-label={label}
              className="group flex items-center gap-2 px-4 py-2.5 rounded-lg border border-dark-600 text-slate-500 hover:text-neon-cyan hover:border-neon-cyan/30 transition-all duration-300 text-sm"
            >
              <Icon size={16} />
